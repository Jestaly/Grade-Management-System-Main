...
Public Class OfficialModifyProgramForm
    ...
    Private Sub modifyButton_Click(sender As Object, e As EventArgs) Handles modifyButton.Click
        Try
            ...
            connector.query = "UPDATE program SET program_name = '" & programnameTextBox.Text & "', year_added = '" & yearAddedTextBox.Text & "', sections = " & sectionBox.Text & " dept_id = '" & " WHERE program_id = '" & trimmedProgID() & "';"
